...
namespace ProjectN.Validators
{
    ...
    public class CardParameterValidator : AbstractValidator<CardParameter>
    {
        ...
        {
            this.RuleFor(card => card.Attack).GreaterThanOrEqualTo(0);

            this.RuleFor(card => card.Health).GreaterThanOrEqualTo(0);

            this.RuleFor(card => card.Cost).GreaterThanOrEqualTo(0);
